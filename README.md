...
Download `annotate.js` and `annotate.css` from the [releases page](https://github.com/Buzz-Interactive/annotate/releases) and serve them from your own origin.
...
- `annotate.js` — compiled, committed, jsDelivr-served. Always rebuild before tagging a release.
